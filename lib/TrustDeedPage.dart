...
class TrustDeedPage extends StatefulWidget {
  const TrustDeedPage({super.key});

  @override
  State<TrustDeedPage> createState() => _TrustDeedPageState();
}

class _TrustDeedPageState extends State<TrustDeedPage> {
  ...
  Future<void> _loadSavedReferences({bool autoSelectFirst = true}) async {
    ...
    try {
      final refs =
          await ApiService().listReferences(documentType: 'trust_deed');
      setState(() {
