...
class JointVentureAgreementPage extends StatefulWidget {
  const JointVentureAgreementPage({super.key});

  @override
  State<JointVentureAgreementPage> createState() => _JointVentureAgreementPageState();
}

class _JointVentureAgreementPageState extends State<JointVentureAgreementPage> {
  ...
  void initState() {
    ...
    _openedFromUploads =
        UploadNavigationContext.consumeReferenceOnlyMode('joint_venture_agreement');
  ...
  void _applyClientToJointVentureParty({
  ...
  String? _jointVentureClientAssignmentLabel({
  ...
  Future<void> _showClientAutofillDialog({
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final assignmentLabel =
                                    _jointVentureClientAssignmentLabel(
                                  clientId: clientId,
                                  currentParty: party,
                                );
    ...
    final assignmentLabel = _jointVentureClientAssignmentLabel(
    ...
    _applyClientToJointVentureParty(party: party, client: selectedClient);
  }
  ...
  Future<void> _loadSavedReferences({bool autoSelectFirst = true}) async {
    ...
    try {
      final refs =
          await ApiService().listReferences(documentType: 'joint_venture_agreement');
      setState(() {
