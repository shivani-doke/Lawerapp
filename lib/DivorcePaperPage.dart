...
class DivorcePaperPage extends StatefulWidget {
  const DivorcePaperPage({super.key});

  @override
  State<DivorcePaperPage> createState() => _DivorcePaperPageState();
}

class _DivorcePaperPageState extends State<DivorcePaperPage> {
  ...
  Future<void> _loadSavedReferences({bool autoSelectFirst = true}) async {
    ...
    try {
      final refs =
          await ApiService().listReferences(documentType: 'divorce_paper');
      setState(() {
