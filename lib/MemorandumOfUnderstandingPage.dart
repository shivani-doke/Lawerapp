...
class MemorandumOfUnderstandingPage extends StatefulWidget {
  const MemorandumOfUnderstandingPage({super.key});

  @override
  State<MemorandumOfUnderstandingPage> createState() => _MemorandumOfUnderstandingPageState();
}

class _MemorandumOfUnderstandingPageState extends State<MemorandumOfUnderstandingPage> {
  ...
  Future<void> _loadSavedReferences({bool autoSelectFirst = true}) async {
    ...
    try {
      final refs =
          await ApiService().listReferences(documentType: 'memorandum_of_understanding');
      setState(() {
