...
class _DocumentsPageState extends State<DocumentsPage> {
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final pagePadding = isCompact ? 16.0 : (isTablet ? 24.0 : 30.0);
          final gridSpacing = isCompact ? 12.0 : (isDesktop ? 16.0 : 20.0);
          final crossAxisCount = width >= 1650
              ? 5
              : width >= 1100
                  ? 4
                  : width >= 700
                      ? 2
                      : 1;
          final childAspectRatio = isCompact
              ? 1.45
              : isTablet
                  ? 1.22
                  : width >= 1650
  ...
  Widget documentCard(
    ...
    return InkWell(
      ...
      child: Container(
        padding: EdgeInsets.all(isCompact ? 16 : (isDesktop ? 18 : 20)),
        ...
        child: Column(
          ...
          children: [
            Container(
              padding: EdgeInsets.all(isCompact ? 10 : (isDesktop ? 11 : 12)),
              decoration: BoxDecoration(
            ...
            Text(
              doc["title"]!,
              style: TextStyle(
                fontSize: isCompact ? 15 : (isDesktop ? 15 : 16),
                fontWeight: FontWeight.bold,
              ),
              maxLines: 2,
            ...
            Expanded(
              child: Text(
                doc["description"]!,
                style: TextStyle(
                  fontSize: isCompact ? 12 : (isDesktop ? 12 : 13),
                  color: Colors.grey,
                  height: isDesktop ? 1.35 : null,
                ),
