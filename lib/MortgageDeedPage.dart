...
class MortgageDeedPage extends StatefulWidget {
  const MortgageDeedPage({super.key});

  @override
  State<MortgageDeedPage> createState() => _MortgageDeedPageState();
}

class _MortgageDeedPageState extends State<MortgageDeedPage> {
  ...
  Future<void> _loadSavedReferences({bool autoSelectFirst = true}) async {
    ...
    try {
      final refs =
          await ApiService().listReferences(documentType: 'mortgage_deed');
      setState(() {
