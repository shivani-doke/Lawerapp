...
class PartitionDeedPage extends StatefulWidget {
  const PartitionDeedPage({super.key});

  @override
  State<PartitionDeedPage> createState() => _PartitionDeedPageState();
}

class _PartitionDeedPageState extends State<PartitionDeedPage> {
  ...
  void initState() {
    ...
    _openedFromUploads =
        UploadNavigationContext.consumeReferenceOnlyMode('partition_deed');
  ...
  String? _partitionClientAssignmentLabel({
                      ...
                      child: filteredClients.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final assignmentLabel = _partitionClientAssignmentLabel(
                                  clientId: clientId,
  ...
  Future<void> _loadSavedReferences({bool autoSelectFirst = true}) async {
    ...
    try {
      final refs =
          await ApiService().listReferences(documentType: 'partition_deed');
      setState(() {
